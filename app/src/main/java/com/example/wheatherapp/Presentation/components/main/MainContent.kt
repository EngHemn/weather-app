...
import com.example.wheatherapp.domain.utils.formatDate
import com.example.wheatherapp.domain.utils.formatDecimals
...
fun MainContent(
    ...
    val unitSymbol by mainViewModel.unitSymbol.collectAsState()
    Surface(
        modifier = modifier
            .fillMaxSize()
            .padding(8.dp),
        ...
        Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(
                        text = formatDecimals(first.temp.day) + "º " + unitSymbol,
